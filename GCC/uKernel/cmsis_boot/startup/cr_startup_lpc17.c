...
extern void MainSVCHandler(void);
...
void (* const g_pfnVectors[])(void) = {
	...
	0,										// Reserved
	0,										// Reserved
	start_first_task,//MainSVCHandler,//vPortSVCHandler,                        // SVCall handler
	DebugMon_Handler,						// Debug monitor handler
	0,										// Reserved
	context_switch,//xPortPendSVHandler,                     // The PendSV handler
	OSTick,//xPortSysTickHandler,                    // The SysTick handler
