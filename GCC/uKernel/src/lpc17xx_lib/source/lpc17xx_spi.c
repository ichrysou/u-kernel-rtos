...
void SPI_Init(LPC_SPI_TypeDef *SPIx, SPI_CFG_Type *SPI_ConfigStruct) {
    ...
    tmp = ((SPI_ConfigStruct->CPHA) | (SPI_ConfigStruct->CPOL) | (SPI_ConfigStruct->DataOrder) | (SPI_ConfigStruct->Databit) |
