...
void port_tickStop(void) { /* SysTick->CTRL &= ~(SysTick_CTRL_ENABLE_Msk); /\* Disable SysTick IRQ and SysTick Timer *\/  */}
...
void port_enableInterrupts(void) { __asm volatile("cpsie i	\n"); }

void port_disableInterrupts(void) { __asm volatile("cpsid i	\n"); }
