...
void stats_init() {
    ...
    /* idleCounter_Max = 0; */
    /* stat_calibration = 0; */
    task_create(STAT_TASK_PRIO, stats_statTask, NULL, STAT_TASK_STACK_SIZE, &StatTaskStack[STAT_TASK_STACK_SIZE - 1], 0);
}

float_32 stats_getCpuUtilization() { return (float_32)cpuUtilization; }
