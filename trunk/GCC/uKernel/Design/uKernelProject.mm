...
<node CREATED="1380410134518" HGAP="116" ID="ID_1164481672" MODIFIED="1381963133995" POSITION="left" TEXT="current- now active" VSHIFT="-214">
...
<node CREATED="1380410300530" ID="ID_1379792865" MODIFIED="1380410317378" TEXT="task manaagement module complete"/>
<node CREATED="1380572688359" HGAP="51" ID="ID_110759574" MODIFIED="1380572699006" TEXT="message queues" VSHIFT="10">
<node CREATED="1382817876095" ID="ID_1042635670" MODIFIED="1382817882640" TEXT="so we have">
...
<node CREATED="1381963135505" ID="ID_1707777245" MODIFIED="1381963142424" TEXT="interrupt enter-exit">
...
<node CREATED="1382031179250" ID="ID_651590212" MODIFIED="1382031189442" TEXT="SCAN THE WHOLE THING FOR RACE CONDITIONS">
<icon BUILTIN="yes"/>
<icon BUILTIN="yes"/>
<icon BUILTIN="yes"/>
<node CREATED="1382031809119" ID="ID_371894262" MODIFIED="1382031813923" TEXT="interrupt enable disable">
<node CREATED="1382041355741" ID="ID_1542948986" MODIFIED="1382903712043" TEXT="use critical nesting variable to see if nested critical regions exist">
<icon BUILTIN="button_ok"/>
</node>
</node>
</node>
<node CREATED="1382819221837" ID="ID_320774760" MODIFIED="1382819246440" TEXT="CHANGE THE CRITICAL SECTION MECHANISM">
...
<node CREATED="1382906765820" ID="ID_36651974" MODIFIED="1382906813342" TEXT="change ReadyTaskBitmap and ReadyTaskIndexto uint_8 and use a LUT to find the hihgest prio resady task"/>
<node CREATED="1383247684551" ID="ID_252924818" MODIFIED="1383692787946" TEXT="ldex/stex -- see 34.3.2.7 Synchronization primitives"/>
<node CREATED="1383326432017" ID="ID_147303228" MODIFIED="1383326451641" TEXT="maybe change all tasks linked list to contain only the delayed tasks">
<icon BUILTIN="yes"/>
<icon BUILTIN="help"/>
</node>
<node CREATED="1383775522780" ID="ID_770168667" MODIFIED="1383775530394" TEXT="memory management (heap)"/>
</node>
